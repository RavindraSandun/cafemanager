...
class OrderViewController: UIViewController {
    ...
    var orderdtlmain :[Orders] = []
    var globleorder : [Orders] = []
    var globle2 : [Orders] = []
        ...
        docRef.getDocuments { (snapshot, error) in
            ...
            else
            {
                for document in (snapshot?.documents)!
                {
                    ...
                    let order = Orders(cusname: cusname, docid: docid, userid: userid, status: status,section: section,orderno: orderno,cusphone: phone)
...
extension OrderViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let viewController = storyboard?.instantiateViewController(withIdentifier: "orderdetailsshow") as! OrderDetailsViewViewController
